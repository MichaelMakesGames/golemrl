...
EVENT_START_SPELL = 'START_SPELL'
EVENT_CAST_SPELL = 'CAST_SPELL'
EVENT_CANCEL_SPELL = 'CANCEL_SPELL'
...
ACTION_CAST_N = 'self.owner.complete_spell((0,-1))'
ACTION_CAST_S = 'self.owner.complete_spell((0,1))'
ACTION_CAST_E = 'self.owner.complete_spell((1,0))'
ACTION_CAST_W = 'self.owner.complete_spell((-1,0))'
ACTION_CAST_NE = 'self.owner.complete_spell((1,-1))'
ACTION_CAST_NW = 'self.owner.complete_spell((-1,-1))'
ACTION_CAST_SE = 'self.owner.complete_spell((1,1))'
ACTION_CAST_SW = 'self.owner.complete_spell((-1,1))'
ACTION_CANCEL_SPELL = 'self.owner.cancel_spell()'
